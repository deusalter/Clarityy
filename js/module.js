...
// class
/*
A class is type of function, but instead of using a keyword function to 
initiate it, we use the kwyword class and the properties are assigned to a constructor() method
Class Definition:
we always use the keyword class to create a class and always use constructor() method
the constructor method is called when the class object is initialized.
syntax:
class class_name{
    constructor(){
...
The constructor is a special method, wher you initialize the 
properties and its is automatically called when a class is 
initiated. This has the same name as the class.
If you do not have a constructor method, JS will add an inviisble empty constructor method
